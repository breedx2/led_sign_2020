...
# sc.center('hello')
# sc.dump()
# sc.msl('TANNING INVITATIONAL is only the start we would really like to have a thing where a frickin laser actually got attached to sharks and outlined some text for us all oh BOY yeah!!', 17)
