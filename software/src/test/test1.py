...
# sc.throb()
# sc.time()
sc.criu('AND NOT FROM THE RIGHT', direction='right', speed=10)
sign.clear()
sc.crid('AND NOW FROM THE RIGHT', direction='right', speed=10)
sign.clear()
sc.criu('I AM JUST A SIMPLE TEST')
sign.clear()
sc.crid('I AM JUST A BASIC TEST')
sign.clear()
